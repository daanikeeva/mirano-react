...
export const Order = () =>  {
    ...
    const handlerPlacedOrder = () => {
        dispatch(plasedOrder())
    }

    const handlerCloseModal = (e) => {
        if (e.target.matches('.order') || e.target.matches('.order__close')) {
            dispatch(closeModal())
        }
    }
    ...
    return (
        <div className="order" onClick={handlerCloseModal}>
            <div className="order__wrapper">
                ...
                <fieldset className="order__fieldset">
                    ...
                    <div className="order__input-group"><input className="order__input" type="text" name="name-buyer" placeholder="Имя" />
                ...
                <fieldset className="order__fieldset">
                    ...
                    <div className="order__input-group">
                        ...
                        <input className="order__input order__input-min" type="text" name="house" placeholder="Дом" />
                ...
                <fieldset className="order__fieldset">
                    <div className="order__payment">
                        <label className="order__label-radio">
                            <input className="order__radio" type="radio" name="payment-online" value="true" defaultChecked />
                            Оплата онлайн
                        </label>
                    </div>
            ...
            <div className="order__footer">
                ...
                <button className="order__button" type="submit" form="order" onClick={handlerPlacedOrder}>Заказать</button>
            </div>
        </>}
        </div>
            <button className="order__close" type="button" onClick={handlerCloseModal}>×</button>
        </div>
    )
